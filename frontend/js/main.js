// main.js - frontend fetch helpers and dynamic parts
const API_BASE = 'http://localhost:5000/api';

// fetch services and show on services page if element exists
async function loadServices() {
    ...
    try{
        ...
        el.innerHTML = '<p>Could not load services.</p>';
    }
}

// fetch opportunities (training/internships)
async function loadOpportunities(){
    ...
    try{
        ...
        const arr = await res.json();
        if(!arr.length) { el.innerHTML = '<p>No opportunities now.</p>'; return; }
        ...
        el.innerHTML = '<p>Could not load opportunities.</p>';
    }
}
